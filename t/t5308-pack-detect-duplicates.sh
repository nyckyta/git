...
# TODO: need to specify the lo oid as a delta against the hi oid
...
test_expect_success 'setup' '
	...
	EOF
	# Write the object for the SHA-256 version of the test so we can pack it.
	printf "\003\326" | git hash-object -w --stdin
'
