...
test_expect_success 'setup' '
	...
	git diff-tree -p default binary >B.diff &&
	git diff-tree -p -C default binary >C.diff &&

	git diff-tree -p --binary default binary >BF.diff &&
	git diff-tree -p --binary -C default binary >CF.diff &&

	git diff-tree -p --full-index default binary >B-index.diff &&
	git diff-tree -p -C --full-index default binary >C-index.diff &&

	git diff-tree -p --binary --no-prefix default binary -- file3 >B0.diff &&
