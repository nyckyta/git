...
test_expect_success 'fetch multiple branches' '
	...
	compare_refs server default local refs/remotes/origin/default &&
...
test_expect_success 'push when remote has extra refs' '
	...
	compare_refs local default server default
'
...
test_expect_success 'push messages' '
	(cd local &&
	git checkout -b new_branch default &&
	echo new >>file &&
	git commit -a -m new &&
