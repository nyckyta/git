...
test_expect_success setup '
	...
	git add dir/default dir/common &&
	test_tick && git commit -m "default has dir/default" &&
	git checkout -b next &&
	git mv dir/default dir/next0 &&
	echo next >dir/next1 &&
	git add dir &&
	test_tick && git commit -m "next has dir/next but not dir/default"
'
...
test_expect_success 'checking out paths out of a tree does not clobber unrelated paths' '
	...
	git checkout default dir &&

	test_cmp expect.common dir/common &&
	test_path_is_file dir/default &&
	git diff --exit-code default dir/default &&
