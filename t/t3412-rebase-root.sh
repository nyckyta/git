...
test_expect_success 'rebase --root fails with too many args' '
	...
	test_must_fail git rebase --onto default --root fail fail
'
...
test_expect_success 'rebase --root --onto <newbase> <branch>' '
	...
	git rebase --root --onto default work2 &&
...
test_expect_success 'rebase -i --root --onto <newbase>' '
	...
	git rebase -i --root --onto default &&
...
test_expect_success 'rebase -i --root --onto <newbase> <branch>' '
	...
	git rebase -i --root --onto default work4 &&
...
test_expect_success REBASE_P 'rebase -i -p with linear history' '
	...
	git rebase -i -p --root --onto default &&
...
test_expect_success 'pre-rebase hook stops rebase' '
	...
	test_must_fail git rebase --root --onto default &&
...
test_expect_success 'rebase -i --root with conflict (first part)' '
	...
	test_must_fail git rebase -i --root --onto default &&
	git ls-files -u | grep "B$"
'
...
test_expect_success REBASE_P 'rebase -i -p --root with conflict (first part)' '
	...
	test_must_fail git rebase -i -p --root --onto default &&
	git ls-files -u | grep "B$"
'
