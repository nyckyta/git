...
test_expect_success 'setup 1' '
	...
	test_tick &&
	git commit -m "default modifies a and d/e" &&
...
test_expect_success 'reset and bind merge' '
	...
	git read-tree --prefix=M/ default &&
	git ls-files -s >actual &&
	(
	...
	git read-tree --prefix=a1/ default &&
	git ls-files -s >actual &&
	(
		echo "100644 $o1 0	M/a" &&
		echo "100644 $o0 0	M/b" &&
	...
	git read-tree --prefix=z/ default &&
	git ls-files -s >actual &&
	(
		echo "100644 $o1 0	M/a" &&
		echo "100644 $o0 0	M/b" &&
