...
# off 'branch1' and then merging in default and checking the results of
# running mergetool

test_expect_success 'setup' '
	test_config rerere.enabled true &&
	echo default >file1 &&
	echo default spaced >"spaced name" &&
	echo default file11 >file11 &&
	echo default file12 >file12 &&
	echo default file13 >file13 &&
	echo default file14 >file14 &&
	mkdir subdir &&
	echo default sub >subdir/file3 &&
	...
	git checkout -b branch1 default &&
	...
	git checkout -b stash1 default &&
	echo stash1 change file11 >file11 &&
	git add file11 &&
	git commit -m "stash1 changes" &&

	git checkout -b stash2 default &&
	...
	git submodule update -N &&
	echo default updated >file1 &&
	echo default new >file2 &&
	echo default updated spaced >"spaced name" &&
	echo default both added >both &&
	echo default updated file12 >file12 &&
	echo default updated file14 >file14 &&
	echo default new sub >subdir/file3 &&
	(
		cd submod &&
		echo default submodule >bar &&
		git add bar &&
		git commit -m "Add bar on default" &&
		git checkout -b submod-default
	) &&
	git add file1 "spaced name" file12 file14 file2 subdir/file3 submod &&
	git add both &&
	git rm file11 &&
	git commit -m "default updates" &&

	git clean -fdx &&
	git checkout -b order-file-start default &&
	echo start >a &&
	echo start >b &&
	git add a b &&
	git commit -m start &&
...
test_expect_success 'custom mergetool' '
	...
	echo "default updated" >expect &&
	test_cmp expect file1 &&
	echo "default new" >expect &&
	test_cmp expect file2 &&
	echo "default new sub" >expect &&
...
test_expect_success 'gui mergetool' '
	...
	echo "gui default updated" >expect &&
	test_cmp expect file1 &&
	echo "gui default new" >expect &&
	test_cmp expect file2 &&
	echo "gui default new sub" >expect &&
	test_cmp expect subdir/file3 &&
	echo "branch1 submodule" >expect &&
	test_cmp expect submod/bar &&
	git commit -m "branch1 resolved with mergetool"
...
test_expect_success 'mergetool crlf' '
	...
	test "$(printf x | cat file1 -)" = "$(printf "default updated\r\nx")" &&
	test "$(printf x | cat file2 -)" = "$(printf "default new\r\nx")" &&
	test "$(printf x | cat subdir/file3 -)" = "$(printf "default new sub\r\nx")" &&
	git submodule update -N &&
	echo "default submodule" >expect &&
	test_cmp expect submod/bar &&
...
test_expect_success 'deleted vs modified submodule' '
	...
	git checkout -b test$test_count.c default &&
	git submodule update -N &&
	...
	git checkout -b test$test_count.d default &&
	git submodule update -N &&
	test_must_fail git merge test$test_count &&
	test -n "$(git ls-files -u)" &&
	yes "" | git mergetool file1 file2 spaced\ name subdir/file3 &&
...
test_expect_success 'custom commands override built-ins' '
	...
	echo default both added >expected &&
