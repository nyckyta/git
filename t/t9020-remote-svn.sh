...
test_expect_success REMOTE_SVN 'simple fetch' '
	init_git &&
	git fetch svnsim &&
	test_cmp .git/refs/svn/svnsim/default .git/refs/remotes/svnsim/default  &&
	cp .git/refs/remotes/svnsim/default default.good
'

test_debug '
	cat .git/refs/svn/svnsim/default
	cat .git/refs/remotes/svnsim/default
'

test_expect_success REMOTE_SVN 'repeated fetch, nothing shall change' '
	git fetch svnsim &&
	test_cmp default.good .git/refs/remotes/svnsim/default
'
...
test_expect_failure REMOTE_SVN 'the sha1 differ because the git-svn-id line in the commit msg contains the url' '
	test_cmp .git/refs/remotes/svnfile/default .git/refs/remotes/svnsim/default
'
