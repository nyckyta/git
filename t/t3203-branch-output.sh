...
test_expect_success "set up color tests" '
	echo "<RED>default<RESET>" >expect.color &&
	echo "default" >expect.bare &&
	color_args="--format=%(color:red)%(refname:short) --list default"
'
...
test_expect_success 'verbose output lists worktree path' '
	...
	two=$(git rev-parse --short default) &&
	cat >expect <<-EOF &&
