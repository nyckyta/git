...
cat > expect <<EOF
 $nested1sha1 nested1 (heads/default)
 $nested2sha1 nested1/nested2 (heads/default)
 $nested3sha1 nested1/nested2/nested3 (heads/default)
 $submodulesha1 nested1/nested2/nested3/submodule (heads/default)
 $sub1sha1 sub1 ($sub1sha1_short)
 $sub2sha1 sub2 ($sub2sha1_short)
 $sub3sha1 sub3 (heads/default)
EOF
