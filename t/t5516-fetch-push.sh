...
test_expect_success 'pushing valid refs triggers post-receive and post-update hooks' '
	...
	orgmaster=$(cd testrepo && git show-ref -s --verify refs/heads/main) &&
	newmaster=$(git show-ref -s --verify refs/heads/main) &&
	...
	(
		...
		$orgmaster $newmaster refs/heads/main
		$orgnext $newnext refs/heads/next
		EOF

		cat >update.expect <<-EOF &&
		refs/heads/main $orgmaster $newmaster
...
test_expect_success 'mixed ref updates, deletes, invalid deletes trigger hooks with correct input' '
	mk_test_with_hooks testrepo heads/main heads/next heads/pu &&
	orgmaster=$(cd testrepo && git show-ref -s --verify refs/heads/main) &&
	newmaster=$(git show-ref -s --verify refs/heads/main) &&
	orgnext=$(cd testrepo && git show-ref -s --verify refs/heads/next) &&
	newnext=$ZERO_OID &&
	orgpu=$(cd testrepo && git show-ref -s --verify refs/heads/pu) &&
	newpu=$(git show-ref -s --verify refs/heads/main) &&
	git push testrepo refs/heads/main:refs/heads/main \
	    refs/heads/main:refs/heads/pu :refs/heads/next \
...
test_expect_success 'push --porcelain' '
	...
	echo >>.git/foo "*	refs/heads/main:refs/remotes/origin/main	[new branch]"  &&
	echo >>.git/foo "Done" &&
