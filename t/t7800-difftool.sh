...
# Create a file on default and change it on branch
...
# Create a second file on default and a different version on branch
...
run_dir_diff_test 'difftool --dir-diff when worktree file is missing' '
	...
	rm file2 &&
	git difftool --dir-diff $symlinks --extcmd ls branch default >output &&
	grep file2 output
'
