...
test_expect_success 'perform sparse checkout of default' '
...
test_expect_success 'merge feature branch into sparse checkout of default' '
	git merge feature &&
	test_path_is_file a &&
	test_path_is_missing b &&
	test_path_is_file c &&
...
test_expect_success 'return to full checkout of default' '
