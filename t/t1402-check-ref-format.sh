...
test_expect_success "check-ref-format --branch @{-1}" '
	...
	git update-ref refs/heads/default $sha1 &&
	git update-ref refs/remotes/origin/default $sha1 &&
...
test_expect_success 'check-ref-format --branch default from non-repo' '
	echo default >expect &&
	nongit git check-ref-format --branch default >actual &&
