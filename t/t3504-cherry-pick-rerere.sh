...
test_expect_success setup '
	test_commit foo &&
	test_commit foo-default foo &&
	test_commit bar-default bar &&
...
test_expect_success 'cherry-pick conflict with --rerere-autoupdate' '
	test_must_fail git cherry-pick --rerere-autoupdate foo..bar-default &&
...
test_expect_success 'cherry-pick conflict repsects rerere.autoUpdate' '
	...
	test_must_fail git cherry-pick foo..bar-default &&
	test_cmp foo-expect foo &&
	git diff-files --quiet &&
	test_must_fail git cherry-pick --continue &&
	test_cmp bar-expect bar &&
...
test_expect_success 'cherry-pick conflict with --no-rerere-autoupdate' '
	test_config rerere.autoUpdate true &&
	test_must_fail git cherry-pick --no-rerere-autoupdate foo..bar-default &&
	test_cmp foo-expect foo &&
...
test_expect_success 'cherry-pick --rerere-autoupdate more than once' '
	test_must_fail git cherry-pick --rerere-autoupdate --rerere-autoupdate foo..bar-default &&
	test_cmp foo-expect foo &&
	git diff-files --quiet &&
	git cherry-pick --abort &&
	test_must_fail git cherry-pick --rerere-autoupdate --no-rerere-autoupdate --rerere-autoupdate foo..bar-default &&
	test_cmp foo-expect foo &&
	git diff-files --quiet &&
	git cherry-pick --abort &&
	test_must_fail git cherry-pick --rerere-autoupdate --no-rerere-autoupdate foo..bar-default &&
	test_must_fail git diff-files --quiet &&
	git cherry-pick --abort
'
...
test_expect_success 'cherry-pick conflict without rerere' '
	...
	test_must_fail git cherry-pick foo-default &&
	grep ===== foo &&
	grep foo-dev foo &&
	grep foo-default foo
'
