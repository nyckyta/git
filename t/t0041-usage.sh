...
test_expect_success 'branch --contains <existent_commit>' '
	git branch --contains "default" >actual 2>actual.err &&
	test_i18ngrep "default" actual &&
	test_line_count = 0 actual.err
'
...
test_expect_success 'branch --no-contains <existent_commit>' '
	git branch --no-contains "default" >actual 2>actual.err &&
	test_line_count = 0 actual &&
	test_line_count = 0 actual.err
'
...
test_expect_success 'for-each-ref --contains <existent_object>' '
	git for-each-ref --contains "default" >actual 2>actual.err &&
...
test_expect_success 'for-each-ref --no-contains <existent_object>' '
	git for-each-ref --no-contains "default" >actual 2>actual.err &&
	test_line_count = 0 actual &&
	test_line_count = 0 actual.err
'
