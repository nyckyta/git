...
test_expect_success 'fetch deleted tags from same revision with no checksum error' '
	...
	git diff --exit-code default:subdir3/file origin/tags/mytag:file &&
	git diff --exit-code default:subdir2/file origin/tags/mytag^:file &&
	git diff --exit-code default:subdir1/file origin/tags/mytag^^:file
'
