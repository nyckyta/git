...
test_expect_success 'fetch without strict' '
	...
	(
		...
		test_must_fail git fetch ../.git default
	)
'
...
cat >exp <<EOF
To dst
!	refs/heads/default:refs/heads/test	[remote rejected] (missing necessary objects)
Done
EOF
...
test_expect_success 'push without strict' '
	...
	test_must_fail git push --porcelain dst default:refs/heads/test >act &&
	test_cmp exp act
'
...
cat >exp <<EOF
To dst
!	refs/heads/default:refs/heads/test	[remote rejected] (unpacker error)
EOF
