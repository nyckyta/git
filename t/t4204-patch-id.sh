...
test_expect_success 'setup' '
	...
	git checkout -b same default &&
	git commit --amend -m same-msg &&
	git checkout -b notsame default &&
	echo c >foo &&
	echo c >bar &&
...
test_expect_success 'patch-id detects equality' '
	get_patch_id default &&
	get_patch_id same &&
	test_cmp patch-id_default patch-id_same
'

test_expect_success 'patch-id detects inequality' '
	get_patch_id default &&
	get_patch_id notsame &&
	! test_cmp patch-id_default patch-id_notsame
'
...
test_patch_id_file_order () {
	...
	shift
	get_top_diff "default" | calc_patch_id "$name" "$@" &&
	git checkout same &&
