...
test_expect_success 'stream allows default as refname' '
	grep default stream
'
...
test_expect_success 'result has two branches' '
	...
	other_branch=$(grep -v refs/heads/default branches)
'
...
test_expect_success 'repo has original shape and timestamps' '
	...
	(cd .. && shape default...other) >expect &&
	shape default...$other_branch >actual &&
