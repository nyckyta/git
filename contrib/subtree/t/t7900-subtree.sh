...
test_expect_success 'no pull from non-existent subtree' '
	...
	(
		cd "$subtree_test_count" &&
		git fetch ./"sub proj" default &&
		test_must_fail git subtree pull --prefix="sub dir" ./"sub proj" default
	)'
...
test_expect_success 'make sure exactly the right set of files ends up in the mainline' '
	...
	(
		cd "$subtree_test_count" &&
		git subtree pull --prefix="sub dir" ./"sub proj" default &&
...
test_expect_success 'make sure "git subtree split" find the correct parent' '
	...
	(
		...
		# not, something went wrong (the "newparent" of "default~" commit should
...
test_expect_success 'subtree descendant check' '
	...
	(
		...
		git subtree split --prefix folder_subtree/ --branch subtree_tip default &&
